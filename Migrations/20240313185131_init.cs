    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 1, "Lauro", "Abreu", 312321 });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 2, "Roberto", "Fagundes", 12312312 });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 3, "Ronaldo", "Aldo", 555432 });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 4, "Rodrigo", "Milho", 983921 });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 5, "Takamasa", "Nomuro", 67678961 });
