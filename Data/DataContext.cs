        ...
        protected override void OnModelCreating(ModelBuilder builder) {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Lauro", "Abreu", 312321),
                    new Professor(2, "Roberto", "Fagundes", 12312312),
                    new Professor(3, "Ronaldo", "Aldo", 555432),
                    new Professor(4, "Rodrigo", "Milho", 983921),
                    new Professor(5, "Takamasa", "Nomuro", 67678961),
                });
